...
[^cris]:In this role, I help researchers and clinicians access and make use of deidentified patient health records at C&I as well as use it myself for research. I offer guidance on study feasibility and design, conduct data extraction, and review outputs. If you're interested, you can learn more [here](https://www.candi.nhs.uk/health-professionals/research/ci-research-database/researchers-and-clinicians), including how to apply for access.

I analyse electronic health records to better understand patients accessing secondary mental health services and their care. I’m interested in the epidemiological applications of administrative and routinely collected data, especially to understand health disparities and mental health, and addressing challenges involved with causal inference from observational data. I am leading the linkage of complementary datasets to the C&I research database[^linkage] as well as the application of machine learning to annotate patient records, including natural language processing of clinical free-text.

[^linkage]:We're currently trying to link data from [Hospital Episode Statistics](https://digital.nhs.uk/data-and-information/data-tools-and-services/data-services/hospital-episode-statistics) (HES), [linked HES-ONS mortality data](https://digital.nhs.uk/data-and-information/data-tools-and-services/data-services/linked-hes-ons-mortality-data), and the [National Cancer Registry](https://www.gov.uk/guidance/national-cancer-registration-and-analysis-service-ncras).
