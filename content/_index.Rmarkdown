...
I analyse electronic health records using epidemiological, causal inference, and machine learning methods to better understand patients accessing secondary mental health services, their care, and their health outcomes. I’m broadly interested in applying administrative and routinely collected data to understand and ameliorate health disparities, including those based on ethnicity, sexual orientation, and socioeconomic status. To date, my work has focused on substance use disorders, severe mental disorders, and personality disorders. 
