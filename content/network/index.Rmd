...
ggplotly(ggnet2(statnet, label =  TRUE, size = "degree", size.cut = 4, color = "membership", edge.color = 'lightgray', label.size = 3, palette = "Pastel1", mode = "fruchtermanreingold", layout.par = list(cell.jitter = 1))) %>%
